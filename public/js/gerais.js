...
function montaDatatableYajra(tabelaId, columns, urlAjax, dataAjax) {
...
function select2(idElemento, url, vaiEstarEmAlgumModal = false, options = {}) {
    if (url) {
        $('#' + idElemento).select2({
...
function maskTelefoneById(elemento) {
...
function maskCNPJById(elemento) {
