...
var routeGetClientes = $('#dataView').data('routeGetClientes');
var routeGetCliente = $('#dataView').data('routeGetCliente');
gerais.montaDatatableYajra('tabela-clientes', columns, routeGetClientes);
...
<ul class="list-group mb-3">
    ...
    <li class="list-group-item"><strong>Documento:</strong> ${gerais.aplicarMascaraDocumento(cliente.documento)}</li>
    <li class="list-group-item"><strong>Data de Nascimento:</strong> ${gerais.aplicarMascaraDataNascimento(cliente.data_nascimento) ?? ''}</li>
    <li class="list-group-item"><strong>Limite de Crédito:</strong> ${gerais.centavosParaReais(cliente.credito.credito_loja) ?? ''}</li>
    <li class="list-group-item"><strong>Celular:</strong> ${gerais.aplicarMascaraCelular(cliente.celular) ?? ''}</li>
    <li class="list-group-item"><strong>Telefone:</strong> ${gerais.aplicarMascaraTelefoneFixo(cliente.telefone_fixo) ?? ''}</li>
