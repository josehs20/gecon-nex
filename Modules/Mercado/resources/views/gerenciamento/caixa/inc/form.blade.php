@vite('Modules/Mercado/resources/assets/js/views/gerenciamento/caixa/inc/form.js', 'build/.vite')
<style>
    .select2-container {
        width: 100% !important;
    }
                            ...
                            <div class="col-md-2">
                                <div class="form-check mt-4">
                                    <input type="checkbox" class="form-check-input" id="superior" name="superior"
                                        value="1">
                                    <label class="form-check-label" for="superior">Liberação com
                                        senha</label>
                                </div>
                            </div>
                            <div class="col-md-2">
