...
class MovimentacaoEstoqueRequest extends ServiceUseCase
{
    private int $loja_id;
    ...
    public function __construct(int $loja_id, int $status_id, int $usuario_id, int $tipo_movimentacao, CriarHistoricoRequest $historicoRequest, $observacao = null)
    {
