@extends('mercado::layouts.app', ['trilhaPaginas' => [['rota' => route('admin.empresa.index'), 'titulo' => 'Página inicia'], ['rota' => route('admin.empresa.index'), 'titulo' => 'Lista de empresas'],['rota' => route('admin.empresa.edit', ['empresa' => $empresa->id]), 'titulo' => 'Editar empresa'], ['titulo' => 'Editar loja']]])
